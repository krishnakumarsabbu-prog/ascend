...
const navByRole: Record<RoleId, { group: string; items: NavItem[] }[]> = {
  EARLY_TALENT: [
    { group: 'Workspace', items: [{ label: 'My Dashboard', icon: LayoutDashboard, to: '/' }, { label: 'Integrated Curriculum', icon: BookOpen, badge: '7', to: '/curriculum' }, { label: 'Pathway Selection', icon: Route }, { label: 'Program Overview', icon: GraduationCap }] },
